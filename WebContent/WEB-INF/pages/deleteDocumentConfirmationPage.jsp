...
<head>
    ...
    <title>Official website of AFC Aldermaston - Delete document confirmation</title>
</head>
<body>
...
<main class="main" style="text-align: center;">
    <div style="background-color: white; margin: 10px 0 0 0; padding: 5px 0 0 0;">
        <h2 style="text-decoration: underline; text-decoration-color: red; width: 100%; text-align: center;">Delete
            document</h2>
        <p style="padding: 0; margin: 0; height: auto;">Are you sure you want to delete this document?</p>
        <p style="color: red; padding: 0; margin: 0;" id="error">${error}</p><br>
        <form id="delete" method="POST" action="deletedocument?id=<%=id%>">

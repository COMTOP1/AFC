...
import com.bswdi.dotenv.internal.DotenvParser;
import com.bswdi.dotenv.internal.DotenvReader;
...
public class DotenvBuilder {
    ...
    static class DotenvImpl implements Dotenv {
        ...
        public DotenvImpl(List<DotenvEntry> envVars) {
            Map<String, String> envVarsInFile = envVars.stream().collect(toMap(DotenvEntry::getKey, DotenvEntry::getValue));

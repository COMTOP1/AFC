package com.bswdi.dotenv.internal;

import com.bswdi.dotenv.DotenvEntry;
import com.bswdi.dotenv.DotenvException;
...
public class DotenvParser {
    ...
    private final Function<String, Boolean> isWhiteSpace = DotenvParser::matches; // ^\s*${'$'}
    ...
    private final Function<String, DotenvEntry> parseLine = DotenvParser::matchEntry; // ^\s*([\w.\-]+)\s*(=)\s*(.*)?\s*$
    ...
    private static DotenvEntry matchEntry(String text) {
